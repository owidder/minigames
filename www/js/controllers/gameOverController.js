com_geekAndPoke_Ngm1.gameOverController = (function() {
    ...
    var gameOverController = com_geekAndPoke_Ngm1.rootController.controller('GameOverController', function ($scope, $timeout) {
        ...
        function draw() {
            ...
            var bubbles = {
                nodes: [
                    ...
                    {name: 'S2t', group:5, clazz:WITH_HREF_CLASS, href:'#/gDStart', color:'gray'}
                ],
